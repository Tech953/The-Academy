 ...
 */
import type { GEDTextbook, GEDLesson, GEDPracticeQuestion } from './gedTypes';
...
export function getAllLessons(): Array<{ subject: string; chapterTitle: string; lesson: import('./gedTypes').GEDLesson }> {
  const result: Array<{ subject: string; chapterTitle: string; lesson: import('./gedTypes').GEDLesson }> = [];
