...
export default function Slide22SafetyFallbacks() {
  return (
    <SlideFrame no="22" eyebrow="21 / SAFETY + FALLBACKS" title="The experience fails soft, not silent">
      ...
      <div className="absolute bottom-[10vh] left-[12vw] right-[12vw] border-t-[0.12vw] border-[#527659] pt-[1.7vh] text-center text-[1.7vw] text-[#9cc7a0]">No fabricated certainty: enriched content is additive, and the canonical state stays local and inspectable.</div>
    </SlideFrame>
  );
}