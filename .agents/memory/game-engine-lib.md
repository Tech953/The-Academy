...
- `contentPack.ts` — ContentPack / PackWorldEvent / PackNpcMood / PackGEDFocus types + PACK_TTL_MS, CONTENT_PACK_STORAGE_KEY, CONTENT_PACK_ENDPOINT, isPackFresh, currentWeekKey. `ContentPackEvent` is a type alias for `PackWorldEvent`.
